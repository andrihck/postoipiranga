function comprarCombustivel() {
    ...
    if (tipoCommbustivel == 1) {
        document.write(`Combustível selecionado: ${tipoCommbustivel} - Álcool. <br> Litros abastecidos: ${qtdLitros}L. <br> Total a pagar: R$ ${qtdLitros * 3.96}`);
    } else {
        document.write(`Combustível selecionado: ${tipoCommbustivel} - Gasolina. <br> Litros abastecidos: ${qtdLitros}L. <br> Total a pagar: R$ ${qtdLitros * 6,20}`);
    }
